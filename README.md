...
- Now, download metadata.json, presence.ts and tsconfig.json outta this repo, and place 'em in a folder named *mejóber*.
- After that, go to {**Activities folder**}/websites/M and place that folder there
- Now, in a terminal, go to the, now placed in the Activities folder, mejóber folder and run the following commands
